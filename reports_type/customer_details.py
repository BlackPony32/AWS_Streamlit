...
def report_func(df):
    ...
    if "Group" in columns and "Total Orders" in columns and "Total Sales" in columns:
        try:
            ...
            print("Error in plot_orders_and_sales_plotly:", e)
    ...
    if "Payment Terms" in columns:
        try:
            ...
            print("Error in bar_plot_sorted_with_percentages:", e)
            st.success("This visualization is temporarily unavailable")
    else:
    ...
    if "Total Sales" in columns:
        try:
            ...
            print("Error in create_interactive_non_zero_sales_plot:", e)
            st.success("This visualization is temporarily unavailable")
    else:
    ...
    if "Total Sales" in columns and "Group" in columns and "Billing State" in columns:
        try:
            ...
            print("Error in create_interactive_average_sales_heatmap:", e)
            st.success("This visualization is temporarily unavailable")    
    ...
    if "Total Sales" in columns and "Group" in columns and "Billing State" in columns:
        try:
            ...
            print("Error in create_sales_trend_by_group:", e)
            st.success("This visualization is temporarily unavailable")
