...
def big_main():
    ...
    with tab1:
        ...
        option = st.selectbox(
            ...
            index=None,
            placeholder="Perhaps one of the following questions will work for you?",
            ...
            if "Product name" in columns and "Grand total" in columns and "QTY" in columns and "Delivery status"in columns:
                with st.container(border=True):
                    ...
                    with col11:
                        ...
                        st.markdown('<p class="big-font">Number of Orders by Product and Delivery Status</p>', unsafe_allow_html=True)
                    with col12:
