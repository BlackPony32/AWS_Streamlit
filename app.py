...
EXPECTED_COLUMNS = {
    ...
    "REP_DETAILS": ["Id", "Name", "Role", "Email", "Phone number", "Total visits", "Total photos", "Total notes", "Total working hours", "Total break hours", "Total travel distance", "Assigned customers", "Active customers", "Inactive customers"],
    "SKU_NOT_ORDERED": ["Category name", "Product name", "SKU", "Manufacturer name", "On hand cases", "Cost", "Cases sold", "Total revenue", "Wholesale price", "Retail price", "Available cases (QTY)"],
    "BEST_SELLERS": ["Category name", "Product name", "SKU", "On hand cases", "Cost", "Allocated cases", "Manufacturer name", "Cases sold", "Total revenue", "Wholesale price", "Retail price", "Available cases (QTY)"],
    "LOW_STOCK_INVENTORY": ["Category name", "Product name", "SKU", "On hand cases", "Total revenue", "Cost", "Allocated cases", "Manufacturer name", "Available cases (QTY)", "Wholesale price", "Retail price"],
    "CURRENT_INVENTORY": ["Category name", "Product name","Total revenue", "Cost", "SKU", "On hand cases", "Allocated cases", "Manufacturer name", "Available cases (QTY)", "Wholesale price", "Retail price"],
    ...
    "ORDER_SALES_SUMMARY": ["Customer ID", "Customer", "Billing Address", "Slotting", "Billing city", "Payment method", "Billing state", "Billing zip", "Shipping Address", "Shipping city", "Shipping state", "Shipping zip", "Order Id", "Created by", "Created at", "Product name", "Product Price", "Product Total", "Manufacturer name", "QTY", "Discount type", "Item specific discount", "Customer discount", "Manufacturer specific discount", "Total invoice discount", "Price list", "Free cases", "Balance", "Payment status", "Expected payment date", "Grand total", "Paid", "Delivery status", "Delivered", "Delivery methods", "Order Note", "Order Status", "Customer contact", "Representative", "Order tags"],
    "TOP_CUSTOMERS": ["Name", "Shipping address", "Shipping city", "Shipping state", "Shipping zip", "Representative", "Billing address", "Billing city", "Billing state", "Billing zip", "Group", "Territory", "Total orders", "Total sales", "Customer discount", "Price list", "Primary payment method", "Order direct access", "Payment terms", "Contact name", "Contact role", "Contact phone", "Contact email", "Phone", "Business email", "Business Fax", "Website", "Tags", "Licenses & certifications"],
    "CUSTOMER_DETAILS": ["Name", "Shipping address", "Shipping city", "Shipping state", "Shipping zip", "Billing address", "Representative", "Billing city", "Billing state", "Billing zip", "Group", "Territory", "Total orders", "Total sales", "Customer discount", "Price list", "Primary payment method", "Order direct access", "Payment terms", "Contact name", "Contact role", "Contact phone", "Contact email", "Phone", "Business email", "Business Fax", "Website", "Tags", "Licenses & certifications"],
}
import pandas as pd
import logging
